...
public class BookDAO {
    ...
    public Book insertBook(Book book){
        ...
        try {
            ...
            preparedStatement.setInt(1, book.getIsbn()); // Set the ISBN
            preparedStatement.setInt(2, book.getAuthor_id()); // Set the author_id
            preparedStatement.setString(3, book.getTitle()); // Set the title
